...
DEPS	:= board.hpp card.hpp c_server_ffi.hpp deck.hpp game.hpp move.hpp player.hpp russian-bank.hpp server_client.hpp texture_generator.hpp 
OBJS 	:= board.o card.o c_server_ffi.o deck.o game.o move.o player.o russian-bank.o server_client.o texture_generator.o c_server_ffi.o
